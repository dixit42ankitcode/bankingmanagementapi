...
public class Accountcontroller {
    ...
    public ResponseEntity<AccountDTO> getaccountbyaccountno(@PathVariable("account_no") long account_no) {
        ...
        try {
            ...
            log.info("exception while handling account details by accountno:{}", account_no);
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
